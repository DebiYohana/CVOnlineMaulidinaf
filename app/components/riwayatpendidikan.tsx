...
export default function RiwayatPendidikan() {
    return (
        ...
        <RowRiwayat jenjang="SMK" sekolah="MA Baitul Arqom Al-Islami" tahun="2019-2022" />
        <RowRiwayat jenjang="Univeristas Ma'soem" sekolah="Prodi D3 KOmputerisasi Akuntansi" tahun="2022-Sekarang" />
        </div>
    )
}
